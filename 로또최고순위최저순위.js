//로또최고순위최저순위 = return은 [최고순위, 최저순위]의 배열
//1. 최고순위 찾기
//1-1. 최고순위의 기준잡기 (변수선언? 데이터설정? 숫자늘림?)
//1-2. 최고순위의 기준 도달을 위해 숫자로 선언해놓고 늘리기.
//1-3. 최고순위에 가기위해 정답개수? 틀린개수? 등의 숫자가 필요
//1-3. 그 결과로 '0'이면 정답개수를 늘려.
//2. 최저순위 찾기
